...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "connection.restart": "Restart extension",
    ...
    "permissions.checkingAll": "Checking platform access…",
    "permissions.clickToEnable": "Click to enable",
    "permissions.disabled": "Not enabled",
    "permissions.enabled": "Enabled",
    "permissions.grantAll": "Grant All Platforms",
    "permissions.grantMissing": "Enable {count} remaining platforms",
    "permissions.allGranted": "All platforms enabled",
    "permissions.requesting": "Waiting for Chrome permission confirmation…",
    "permissions.requestingOne": "Requesting access to {platform}…",
    "permissions.grantedCount": "Enabled {count} platforms.",
    "permissions.grantedOne": "Enabled {platform}.",
    "permissions.partial": "Enabled {granted}; {remaining} still need permission. Click to retry.",
    "permissions.denied": "Permission was not granted. You can retry without changing existing access.",
    "permissions.failed": "Chrome could not update platform permissions. Please retry.",
    "permissions.help": "Access is only used to fill visible draft editors. Cookies are never read.",
  ...
  "zh-CN": {
    ...
    "connection.restart": "重载扩展",
    "connection.restarting": "正在重载…",
    ...
    "permissions.checkingAll": "正在检查平台权限…",
    "permissions.clickToEnable": "点击启用",
    "permissions.disabled": "未启用",
    "permissions.enabled": "已启用",
    "permissions.grantMissing": "一键授权剩余 {count} 个平台",
    "permissions.allGranted": "全部平台已授权",
    "permissions.requesting": "请在 Chrome 权限窗口中确认…",
    "permissions.requestingOne": "正在请求 {platform} 权限…",
    "permissions.grantedCount": "已启用 {count} 个平台。",
    "permissions.grantedOne": "已启用 {platform}。",
    "permissions.partial": "已启用 {granted} 个，仍有 {remaining} 个未授权；可再次点击重试。",
    "permissions.denied": "本次未授予权限；可以安全重试，现有授权不会改变。",
    "permissions.failed": "Chrome 未能更新平台权限，请重试。",
    "permissions.help": "权限仅用于填写你打开的草稿编辑器，不读取 Cookie。",
